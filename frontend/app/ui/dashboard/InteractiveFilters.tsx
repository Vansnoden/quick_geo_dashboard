  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      <div
        ...
        className={`w-full min-h-[38px] px-3 py-2 bg-white border border-gray-300 rounded-lg cursor-pointer flex items-center justify-between hover:border-purple-400 transition-colors ${
