  ...
  return (
    <>
      <Header></Header>
        ...
        {/* Header */}
        <div className="bg-white border-b border-gray-200 pt-8 mt-5">
            ...
            <div className="lg:col-span-3 prose prose-purple max-w-none">
              ...
              <section id="getting-started" className="mb-12">
                ...
                <p className="text-gray-700">
                  Welcome to the QGeoDash tool! This platform allows you to transform your CSV or Excel data into interactive, 
        ...
        A comprehensive visualization platform for sand fly vector surveillance data...`}
              ...
              <div className="border-t border-gray-200 pt-8 mt-12">
                <p className="text-sm text-gray-500 text-center">
                  Version 1.1.0 | Last updated: September 2026 | © 2025 QGeoDash Platform
                </p>
              </div>
            </div>
          </div>
