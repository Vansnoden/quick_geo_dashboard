            ...
            >
                <div className="space-y-4 rounded-lg bg-white px-6 py-8 shadow-md">
                    ...
                    <div className="relative">
                        <input
                            className="peer block w-full rounded-md border border-gray-300 py-2.5 pl-10 text-sm 
                                text-gray-900 outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500"
                            id="fullname"
                            type="text"
                            name="fullname"
